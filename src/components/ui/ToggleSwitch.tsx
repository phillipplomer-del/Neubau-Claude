      ...
      >
        <div className="relative">
          <input
            ...
            {...props}
          />
          {/* Track - uses primary color (Aqua light / Gold dark) */}
          <div className="w-11 h-6 rounded-full transition-all duration-200 ease-out bg-card-muted border border-border peer-checked:border-transparent peer-checked:bg-primary peer-disabled:opacity-50" />
