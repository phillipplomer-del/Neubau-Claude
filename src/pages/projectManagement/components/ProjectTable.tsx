...
import CommentTooltip from '@/pages/sales/components/CommentTooltip';
...
export default function ProjectTable({ data, sorting, onSortingChange, onRowClick, statusMap }: ProjectTableProps) {
            ...
            {virtualRows.map((virtualRow) => {
              ...
              const handleRowClick = (e: React.MouseEvent) => {
                ...
                if (onRowClick) {
                  ...
                  navigate(`/projects/list/${entry.id}`);
                }
              };
