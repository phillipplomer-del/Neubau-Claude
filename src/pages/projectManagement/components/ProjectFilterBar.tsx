 ...
 * Quick filters, search, and date filter for project data
 */

import Button from '@/components/ui/Button';
import Input from '@/components/ui/Input';
import type { FilterMode, ProjectFilters, StatusFilter } from '@/hooks/useProjectFilters';
      ...
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <div className="flex-1 min-w-[250px]">
          <Input
            id="search"
            type="text"
            placeholder="Suche: Artikelnr., Projektnr., Kunde, Produkt, Projektleiter..."
